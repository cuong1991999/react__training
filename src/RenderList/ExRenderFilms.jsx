...
export default class ExRenderFilms extends Component {
  renderFilm = () => {
    let arrDiv = arrFilm.map((film, index) => {
      return (
        <div className="col-2 mt-2" key={index}>
          <div className="card">
            <img
              ...
              alt=""
              height={300}
              style={{ objectFitL: "cover" }}
            />
            <div className="card-body bg-dark text-white">
              <h4 className="mb-2" style={{ heigt: 50, fontSize: "14px" }}>
                {film.tenPhim}
              </h4>
              <p className="m-0" style={{ height: 100 }}>
    ...
    return (
      <div className="background-film">
        ...
        >
          ...
          <div className="list-film mt-2 row">{this.renderFilm()}</div>
        </div>
      </div>
    );
  }
